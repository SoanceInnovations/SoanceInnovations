...
const records = cases.map((c, index) => {
...
fs.writeFileSync(
  ...
  `/* Fictionalized portfolio case studies generated by scripts/generate_fictional_case_studies.mjs. */\nwindow.SOANCE_CASE_STUDIES=${JSON.stringify(records)};\n`
);

console.log(`Generated ${records.length} fictional case studies and logos using realistic photo assets.`);
